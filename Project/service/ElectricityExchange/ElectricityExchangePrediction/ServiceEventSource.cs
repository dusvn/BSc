...
{
    [EventSource(Name = "MyCompany-ElectricityExchange-ElectricityExchangePrediction")]
    internal sealed class ServiceEventSource : EventSource
    {
        ...
        [Event(3, Message = "{0}", Level = EventLevel.Error)]
        public void Error(string message) => WriteEvent(3, message);

        [Event(4, Message = "{0}", Level = EventLevel.Critical)]
        public void Critical(string message) => WriteEvent(4, message);
